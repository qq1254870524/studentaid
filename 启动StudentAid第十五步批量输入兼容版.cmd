...
cd /d "%~dp0"
title StudentAid Step 15 Input Compatibility - Install and Start
set "PYTHONDONTWRITEBYTECODE=1"

if not exist "%~dp0ait10.py" (
    echo [ERROR] ait10.py is missing from this directory.
    pause
    exit /b 1
)
...
echo [START] StudentAid Step 15 Input Compatibility...
"%APP_PY%" -B "%~dp0ait10.py"
