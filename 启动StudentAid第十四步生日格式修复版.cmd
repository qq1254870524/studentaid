...
cd /d "%~dp0"
title StudentAid Step 14 DOB Format Fix - Install and Start
set "PYTHONDONTWRITEBYTECODE=1"

if not exist "%~dp0ait9.py" (
    echo [ERROR] ait9.py is missing from this directory.
    pause
    exit /b 1
)
...
echo [START] StudentAid Step 14 DOB Format Fix...
"%APP_PY%" -B "%~dp0ait9.py"
