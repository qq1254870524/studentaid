...
cd /d "%~dp0"
title StudentAid Step 13 Contact Fix - Install and Start
set "PYTHONDONTWRITEBYTECODE=1"

if not exist "%~dp0ait8.py" (
    echo [ERROR] ait8.py is missing from this directory.
    pause
    exit /b 1
)
...
echo [START] StudentAid Step 13 Contact Fix...
"%APP_PY%" -B "%~dp0ait8.py"
