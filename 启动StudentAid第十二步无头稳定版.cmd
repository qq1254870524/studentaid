...
cd /d "%~dp0"
title StudentAid Step 12 Headless Stable - Install and Start
set "PYTHONDONTWRITEBYTECODE=1"

if not exist "%~dp0ait7.py" (
    echo [ERROR] ait7.py is missing from this directory.
    pause
    exit /b 1
)
...
echo [START] StudentAid Step 12 Headless Stable...
"%APP_PY%" -B "%~dp0ait7.py"
